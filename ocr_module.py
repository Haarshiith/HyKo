...
def get_ocr(lang="de"):
    ...
    return PaddleOCR(
        ...
        lang=lang, 
        # Alter Name: det_db_unclip_ratio -> Neuer Name: text_det_unclip_ratio
        text_det_unclip_ratio=1.5, 
        # WICHTIG: Das hier verhindert den Absturz/Hänger!
        enable_mkldnn=False,
    )
...
# ============================================================================
# MAIN EXECUTION (MIT DEBUG PRINTS)
# ============================================================================

if __name__ == "__main__":
    # PFAD VARIABEL ANPASSEN!
    directory = r"D:\VS Code Env\OCR IMPROVED"
    texte, scores = ocr_all_pdfs_to_token_lists(directory)
    print("Fertig mit Testlauf.")